...
const textTranslations: Record<string, Record<Locale, string>> = {
  ...
  "Structure en ossature bois réalisée selon les normes en vigueur, contreventée par panneaux OSB 12 mm assurant rigidité et stabilité de l’ensemble. Comprend les murs porteurs, murs de séparation et charpente industrielle type fermette. Le prix inclut le transport et le montage sur site sous garantie décennale.": {
    ...
    en: "Timber frame structure built according to current standards, braced by 12 mm OSB panels to ensure rigidity and stability. Includes load-bearing walls, partition walls, and industrial trusses. Transport and assembly are additional and calculated separately when the project is validated.",
    de: "Holzrahmenstruktur nach den geltenden Normen gebaut und mit 12-mm-OSB-Platten ausgesteift. Umfasst tragende Wände, Trennwände und Dachbinder. Transport und Montage sind Zusatzleistungen und werden bei der Projektbestätigung separat berechnet.",
    nl: "Houtskeletstructuur gebouwd volgens de geldende normen en geschoord met 12 mm OSB-platen. Inclusief dragende muren, scheidingswanden en spanten. Transport en montage zijn extra en worden bij de projectbevestiging afzonderlijk berekend."
  },
