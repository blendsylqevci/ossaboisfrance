...
// Configuration
const HOUSE_SLUG = 'diademe-toiture-terrasse';
const SOURCE_DIR = path.join(__dirname, '..', 'public', 'images', 'houses', 'diademe me atike');

// List of layers to process and upload
const filesToProcess = [
  { file: '1. prapavija-Recovered.png', key: 'diademe-atike_1._Parahyrja.png', layer: 'background' },
  { file: '2. kons.png', key: 'diademe-atike_2._kons.png', layer: 'construction' },
  { file: '3. lesh guri.png', key: 'diademe-atike_3._lesh_guri.png', layer: 'iso_inter_roche' },
  { file: '4. lesh druri.png', key: 'diademe-atike_4._lesh_druri.png', layer: 'iso_inter_bois' },
  { file: '5. lesh xhami.png', key: 'diademe-atike_5._lesh_xhami.png', layer: 'iso_inter_verre' },
  { file: '6. stiropori.png', key: 'diademe-atike_6._stiropori.png', layer: 'iso_ext_polystyrene' },
  { file: '7. fibra.png', key: 'diademe-atike_7._fibra.png', layer: 'iso_ext_fibre' },
  { file: '8. lesh guri jashte.png', key: 'diademe-atike_8._lesh_guri_jashte.png', layer: 'iso_ext_roche_comprimee' },
  { file: '9. stiropori atikes.png', key: 'diademe-atike_9._stiropori_atikes.png', layer: 'terrace_etancheite_epdm' },
  { file: '10. epdm.png', key: 'diademe-atike_10._epdm.png', layer: 'etancheite_epdm' },
  { file: '11. Fasada e bardhe.png', key: 'diademe-atike_11._fasada_e_bardhe.png', layer: 'facade_blanche' },
  { file: '12. fasada arish.png', key: 'diademe-atike_12._fasada_arish.png', layer: 'facade_bardage' },
  { file: '13. dritaret alumin.png', key: 'diademe-atike_13._dritaret_alumin.png', layer: 'windows_aluminium' },
  { file: '14. dritaret pvc.png', key: 'diademe-atike_14._dritaret_pvc.png', layer: 'windows_pvc' },
  { file: '7 diademe.jpg', key: 'diademe-atike_default.jpg', layer: 'default_image' },
  { file: '10 diademe.jpg', key: 'diademe-atike_final.jpg', layer: 'final_image' }
];
...
async function main() {
  ...
  try {
    ...
    // Clean up old diademe-atike media from DB
    console.log(' - Cleaning up old diademe-atike media from DB...');
    await pgClient.query(`
      DELETE FROM media_locales 
      WHERE _parent_id IN (
        SELECT id FROM media WHERE filename LIKE 'diademe-atike\\_%' ESCAPE '\\'
      )
    `);
    const cleanupRes = await pgClient.query(`
      DELETE FROM media WHERE filename LIKE 'diademe-atike\\_%' ESCAPE '\\' RETURNING id
    `);
    ...
    await pgClient.query(
      `UPDATE houses
       SET 
         ...
         price60x200 = 27600,
         margin_percent = 40,
         perdhesa_bruto = 112.72,
         perdhesa_neto = 98,
         perdhesa_mure_te_jashtme = 130,
         perdhesa_mure_mbajtese = 43,
         perdhesa_mure_ndarese = 54,
         perdhesa_pllaka_e_kulmit = 148,
         perdhesa_kulmi = 148,
         windows_aluminium_price = 8922,
         windows_pvc_price = 5377,
    ...
    const frenchDescription = `Le modèle Diademe Toiture Terrasse reflète une vision contemporaine de l’habitat, où simplicité architecturale, élégance naturelle et confort moderne se rencontrent harmonieusement.\n\nAvec sa toiture terrasse aux lignes épurées et sa façade en bois naturel au style raffine, cette maison offre une esthétique chaleureuse et intemporelle, parfaitement adaptée aux environnements modernes comme aux paysages naturels. Pensée pour maximiser la lumière naturelle et la fluidité des espaces.`;
    const frenchSubheading = `Diademe Toiture Terrasse — Simplicité architecturale, élégance naturelle et confort moderne.`;
