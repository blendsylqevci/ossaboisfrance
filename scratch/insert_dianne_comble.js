...
const IMAGES_DIR = '/Users/blendsylqevci/Desktop/Projects/ossaboisfrance/public/images/houses/Dianne Comble';

const fileMappings = [
  {
    localName: '1. Prapavija.png',
    targetName: 'dianne-comble_1._prapavija.png',
    dbColumn: 'layers_background_layer_id',
    alt: 'Dianne Comble - Arrière-plan',
    mime: 'image/png'
  },
  {
    localName: '2. kons.png',
    targetName: 'dianne-comble_2._kons.png',
    dbColumn: 'layers_construction_layer_id',
    alt: 'Dianne Comble - Structure de construction',
    mime: 'image/png'
  },
  {
    localName: '3. lesh guri.png',
    targetName: 'dianne-comble_3._lesh_guri.png',
    dbColumn: 'layers_iso_inter_roche_id',
    alt: 'Dianne Comble - Isolation intermédiaire laine de roche',
    mime: 'image/png'
  },
  {
    localName: '4. lesh druri.png',
    targetName: 'dianne-comble_4._lesh_druri.png',
    dbColumn: 'layers_iso_inter_bois_id',
    alt: 'Dianne Comble - Isolation intermédiaire laine de bois',
    mime: 'image/png'
  },
  {
    localName: '5. lesh xhami.png',
    targetName: 'dianne-comble_5._lesh_xhami.png',
    dbColumn: 'layers_iso_inter_verre_id',
    alt: 'Dianne Comble - Isolation intermédiaire laine de verre',
    mime: 'image/png'
  },
  {
    localName: '6. lesh guri ne kulm.png',
    targetName: 'dianne-comble_6._lesh_guri_ne_kulm.png',
    dbColumn: 'layers_roof_roche_id',
    alt: 'Dianne Comble - Isolation toiture laine de roche',
    mime: 'image/png'
  },
  {
    localName: '7. lesh druri ne kulm.png',
    targetName: 'dianne-comble_7._lesh_druri_ne_kulm.png',
    dbColumn: 'layers_roof_bois_id',
    alt: 'Dianne Comble - Isolation toiture laine de bois',
    mime: 'image/png'
  },
  {
    localName: '8. lesh xhami ne kulm.png',
    targetName: 'dianne-comble_8._lesh_xhami_ne_kulm.png',
    dbColumn: 'layers_roof_verre_id',
    alt: 'Dianne Comble - Isolation toiture laine de verre',
    mime: 'image/png'
  },
  {
    localName: '9. stiropori.png',
    targetName: 'dianne-comble_9._stiropori.png',
    dbColumn: 'layers_iso_ext_polystyrene_id',
    alt: 'Dianne Comble - Isolation extérieure polystyrène',
    mime: 'image/png'
  },
  {
    localName: '10. lesh guri jashte.png',
    targetName: 'dianne-comble_10._lesh_guri_jashte.png',
    dbColumn: 'layers_iso_ext_roche_comprimee_id',
    alt: 'Dianne Comble - Isolation extérieure laine de roche',
    mime: 'image/png'
  },
  {
    localName: '11. fibra.png',
    targetName: 'dianne-comble_11._fibra.png',
    dbColumn: 'layers_iso_ext_fibre_id',
    alt: 'Dianne Comble - Isolation extérieure fibre de bois',
    mime: 'image/png'
  },
  {
    localName: '12. folia dhe listelat.png',
    targetName: 'dianne-comble_12._folia_dhe_listelat.png',
    dbColumn: 'layers_couverture_pare_pluie_lattage_id',
    alt: 'Dianne Comble - Pare-pluie et lattage',
    mime: 'image/png'
  },
  {
    localName: '13. fasada e bardhe.png',
    targetName: 'dianne-comble_13._fasada_e_bardhe.png',
    dbColumn: 'layers_facade_blanche_id',
    alt: 'Dianne Comble - Façade enduit blanc',
    mime: 'image/png'
  },
  {
    localName: '14. fasada arish.png',
    targetName: 'dianne-comble_14._fasada_arish.png',
    dbColumn: 'layers_facade_bardage_id',
    alt: 'Dianne Comble - Façade bardage mélèze',
    mime: 'image/png'
  },
  {
    localName: '15 dritaret alumin.png',
    targetName: 'dianne-comble_15._dritaret_alumin.png',
    dbColumn: 'layers_windows_aluminium_id',
    alt: 'Dianne Comble - Menuiseries aluminium',
    mime: 'image/png'
  },
  {
    localName: '16. dritaret pvc.png',
    targetName: 'dianne-comble_16._dritaret_pvc.png',
    dbColumn: 'layers_windows_pvc_id',
    alt: 'Dianne Comble - Menuiseries PVC',
    mime: 'image/png'
  },
  {
    localName: '17. qeremidet.png',
    targetName: 'dianne-comble_17._qeremidet.png',
    dbColumn: 'layers_couverture_tuiles_gouttieres_id',
    alt: 'Dianne Comble - Couverture tuiles et gouttières',
    mime: 'image/png'
  },
  {
    localName: '18. llamarina.png',
    targetName: 'dianne-comble_18._llamarina.png',
    dbColumn: 'layers_couverture_bac_acier_gouttieres_id',
    alt: 'Dianne Comble - Couverture bac acier et gouttières',
    mime: 'image/png'
  },
  {
    localName: '19. lesh guri ne pllake.png',
    targetName: 'dianne-comble_19._lesh_guri_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_roche_id',
    alt: 'Dianne Comble - Faux plafond laine de roche',
    mime: 'image/png'
  },
  {
    localName: '20. lesh druri ne pllake.png',
    targetName: 'dianne-comble_20._lesh_druri_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_bois_id',
    alt: 'Dianne Comble - Faux plafond laine de bois',
    mime: 'image/png'
  },
  {
    localName: '21. lesh xhami ne pllake.png',
    targetName: 'dianne-comble_21._lesh_xhami_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_verre_id',
    alt: 'Dianne Comble - Faux plafond laine de verre',
    mime: 'image/png'
  },
  {
    localName: 'dianne comble 7.jpg',
    targetName: 'dianne-comble_default.jpg',
    dbColumn: 'default_image_id',
    alt: 'Dianne Comble',
    mime: 'image/jpeg'
  },
  {
    localName: 'dianne comble 10.jpg',
    targetName: 'dianne-comble_final.jpg',
    dbColumn: 'final_image_id',
    alt: 'Dianne Comble - Rendu Final',
    mime: 'image/jpeg'
  }
];
...
async function main() {
  ...
  try {
    ...
    // Reset foreign keys on houses table referencing dianne-comble media to prevent cascade delete conflicts
    console.log(' - Resetting house ID 28 media references before cleanup...');
    ...
    // Clean up existing media registers for dianne-comble if any to prevent duplicates on rerun
    console.log(' - Cleaning up old dianne-comble media from DB...');
    await pgClient.query(`
      DELETE FROM media_locales 
      WHERE _parent_id IN (
        SELECT id FROM media WHERE filename LIKE 'dianne-comble\\_%' ESCAPE '\\'
      )
    `);
    const cleanupRes = await pgClient.query(`
      DELETE FROM media WHERE filename LIKE 'dianne-comble\\_%' ESCAPE '\\' RETURNING id
    `);
    ...
    // Update dianne house in houses
    console.log(' - Updating house id 28 (dianne) in houses table...');
    const updateHouseQuery = `
      ...
      SET 
        ...
        price60x160 = $4,
        price60x200 = $5,
        enable_flags_enable_roof_option = $6,
        enable_flags_enable_etancheite_option = $7,
        enable_flags_enable_etancheite_terrasse = $8,
        enable_flags_enable_couverture_option = $9,
        enable_flags_enable_faux_plafond_option = $10,
        layers_background_layer_id = $11,
        layers_construction_layer_id = $12,
        layers_iso_inter_roche_id = $13,
        layers_iso_inter_bois_id = $14,
        layers_iso_inter_verre_id = $15,
        layers_roof_roche_id = $16,
        layers_roof_bois_id = $17,
        layers_roof_verre_id = $18,
        layers_iso_ext_polystyrene_id = $19,
        layers_iso_ext_roche_comprimee_id = $20,
        layers_iso_ext_fibre_id = $21,
        layers_couverture_pare_pluie_lattage_id = $22,
        layers_facade_blanche_id = $23,
        layers_facade_bardage_id = $24,
        layers_windows_aluminium_id = $25,
        layers_windows_pvc_id = $26,
        layers_couverture_tuiles_gouttieres_id = $27,
        layers_couverture_bac_acier_gouttieres_id = $28,
        layers_faux_plafond_roche_id = $29,
        layers_faux_plafond_bois_id = $30,
        layers_faux_plafond_verre_id = $31,
        updated_at = $32
      WHERE id = 28
    `;
    ...
    await pgClient.query(updateHouseQuery, [
      ...
      26675, // price60x160
      28175, // price60x200 (added as requested)
    ...
    console.log('House record ID 28 updated successfully.');

    // Update houses_locales table record for _parent_id = 28
    ...
    const updateHouseLocQuery = `
      ...
      SET
        ...
        description = $3,
        structure_info = $4
      WHERE _parent_id = 28 AND _locale = 'fr'
    `;
    
    const frenchDescription = `Le modèle Dianne Comble allie charme traditionnel et performance énergétique. Avec sa toiture à forte pente abritant des combles aménageables, il offre une flexibilité d'aménagement optimale pour s'adapter à l'évolution de votre famille. Sa structure robuste en ossature bois à haute efficacité thermique (conforme RE2020) garantit un confort de vie inégalé en toutes saisons.`;
    
    const frenchSubheading = `Découvrez Dianne Comble, un modèle de maison d'exception à combles aménageables avec une structure bois performante.`;
    ...
    console.log('House localization updated successfully.');
