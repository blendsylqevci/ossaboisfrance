...
const IMAGES_DIR = '/Users/blendsylqevci/Desktop/Projects/ossaboisfrance/public/images/houses/Els House comble';

const fileMappings = [
  {
    localName: '1. prapavija.png',
    targetName: 'els-house-comble_1._prapavija.png',
    dbColumn: 'layers_background_layer_id',
    alt: 'Els House Comble - Arrière-plan',
    mime: 'image/png'
  },
  {
    localName: '2. kons.png',
    targetName: 'els-house-comble_2._kons.png',
    dbColumn: 'layers_construction_layer_id',
    alt: 'Els House Comble - Structure de construction',
    mime: 'image/png'
  },
  {
    localName: '3. lesh guri.png',
    targetName: 'els-house-comble_3._lesh_guri.png',
    dbColumn: 'layers_iso_inter_roche_id',
    alt: 'Els House Comble - Isolation intermédiaire laine de roche',
    mime: 'image/png'
  },
  {
    localName: '4. lesh druri.png',
    targetName: 'els-house-comble_4._lesh_druri.png',
    dbColumn: 'layers_iso_inter_bois_id',
    alt: 'Els House Comble - Isolation intermédiaire laine de bois',
    mime: 'image/png'
  },
  {
    localName: '5. lesh xhami.png',
    targetName: 'els-house-comble_5._lesh_xhami.png',
    dbColumn: 'layers_iso_inter_verre_id',
    alt: 'Els House Comble - Isolation intermédiaire laine de verre',
    mime: 'image/png'
  },
  {
    localName: '6. lesh guri ne kulm.png',
    targetName: 'els-house-comble_6._lesh_guri_ne_kulm.png',
    dbColumn: 'layers_roof_roche_id',
    alt: 'Els House Comble - Isolation toiture laine de roche',
    mime: 'image/png'
  },
  {
    localName: '7. lesh druri ne kulm.png',
    targetName: 'els-house-comble_7._lesh_druri_ne_kulm.png',
    dbColumn: 'layers_roof_bois_id',
    alt: 'Els House Comble - Isolation toiture laine de bois',
    mime: 'image/png'
  },
  {
    localName: '8. lsh xhami ne kulm.png',
    targetName: 'els-house-comble_8._lesh_xhami_ne_kulm.png',
    dbColumn: 'layers_roof_verre_id',
    alt: 'Els House Comble - Isolation toiture laine de verre',
    mime: 'image/png'
  },
  {
    localName: '9. stiropori.png',
    targetName: 'els-house-comble_9._stiropori.png',
    dbColumn: 'layers_iso_ext_polystyrene_id',
    alt: 'Els House Comble - Isolation extérieure polystyrène',
    mime: 'image/png'
  },
  {
    localName: '10 lesh guri jashte.png',
    targetName: 'els-house-comble_10._lesh_guri_jashte.png',
    dbColumn: 'layers_iso_ext_roche_comprimee_id',
    alt: 'Els House Comble - Isolation extérieure laine de roche',
    mime: 'image/png'
  },
  {
    localName: '11. fibra.png',
    targetName: 'els-house-comble_11._fibra.png',
    dbColumn: 'layers_iso_ext_fibre_id',
    alt: 'Els House Comble - Isolation extérieure fibre de bois',
    mime: 'image/png'
  },
  {
    localName: '12. folia dhe listelat.png',
    targetName: 'els-house-comble_12._folia_dhe_listelat.png',
    dbColumn: 'layers_couverture_pare_pluie_lattage_id',
    alt: 'Els House Comble - Pare-pluie et lattage',
    mime: 'image/png'
  },
  {
    localName: '13. fasada e bardhe.png',
    targetName: 'els-house-comble_13._fasada_e_bardhe.png',
    dbColumn: 'layers_facade_blanche_id',
    alt: 'Els House Comble - Façade enduit blanc',
    mime: 'image/png'
  },
  {
    localName: '14. fasada arish.png',
    targetName: 'els-house-comble_14._fasada_arish.png',
    dbColumn: 'layers_facade_bardage_id',
    alt: 'Els House Comble - Façade bardage mélèze',
    mime: 'image/png'
  },
  {
    localName: '15. dritaret alumin.png',
    targetName: 'els-house-comble_15._dritaret_alumin.png',
    dbColumn: 'layers_windows_aluminium_id',
    alt: 'Els House Comble - Menuiseries aluminium',
    mime: 'image/png'
  },
  {
    localName: '16. dritaret pvc.png',
    targetName: 'els-house-comble_16._dritaret_pvc.png',
    dbColumn: 'layers_windows_pvc_id',
    alt: 'Els House Comble - Menuiseries PVC',
    mime: 'image/png'
  },
  {
    localName: '17. llamarina.png',
    targetName: 'els-house-comble_17._llamarina.png',
    dbColumn: 'layers_couverture_bac_acier_gouttieres_id',
    alt: 'Els House Comble - Couverture bac acier et gouttières',
    mime: 'image/png'
  },
  {
    localName: 'els house 7.jpg',
    targetName: 'els-house-comble_default.jpg',
    dbColumn: 'default_image_id',
    alt: 'Els House Comble',
    mime: 'image/jpeg'
  },
  {
    localName: 'els house 10.jpg',
    targetName: 'els-house-comble_final.jpg',
    dbColumn: 'final_image_id',
    alt: 'Els House Comble - Rendu Final',
    mime: 'image/jpeg'
  }
];
...
async function main() {
  ...
  try {
    ...
    // Clean up existing house row with slug 'els-house-comble' if exists to prevent duplicates
    console.log(' - Cleaning up old els-house-comble references if any...');
    
    // First, find the house ID if it exists
    const findHouseRes = await pgClient.query("SELECT id FROM houses WHERE slug = 'els-house-comble'");
    ...
    console.log(' - Cleaning up old els-house-comble media from DB...');
    await pgClient.query(`
      DELETE FROM media_locales 
      WHERE _parent_id IN (
        SELECT id FROM media WHERE filename LIKE 'els-house-comble\\_%' ESCAPE '\\'
      )
    `);
    const cleanupRes = await pgClient.query(`
      DELETE FROM media WHERE filename LIKE 'els-house-comble\\_%' ESCAPE '\\' RETURNING id
    `);
    ...
    console.log(' - Inserting house els-house-comble in houses table...');
    ...
    const houseRes = await pgClient.query(insertHouseQuery, [
      ...
      false, // enable_flags_enable_faux_plafond_option
      ...
      null, // layers_couverture_tuiles_gouttieres_id
      uploadedMediaIds['layers_couverture_bac_acier_gouttieres_id'],
      null, // layers_faux_plafond_roche_id
      null, // layers_faux_plafond_bois_id
      null, // layers_faux_plafond_verre_id
      now,
      now
    ]);
    const newHouseId = houseRes.rows[0].id;
    console.log(`Successfully inserted house els-house-comble with ID: ${newHouseId}`);
