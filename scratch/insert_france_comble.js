...
const IMAGES_DIR = '/Users/blendsylqevci/Desktop/Projects/ossaboisfrance/public/images/houses/France comble';

const fileMappings = [
  {
    localName: '1. prapavija.png',
    targetName: 'france-comble_1._prapavija.png',
    dbColumn: 'layers_background_layer_id',
    alt: 'France Comble - Arrière-plan',
    mime: 'image/png'
  },
  {
    localName: '2. kons.png',
    targetName: 'france-comble_2._kons.png',
    dbColumn: 'layers_construction_layer_id',
    alt: 'France Comble - Structure de construction',
    mime: 'image/png'
  },
  {
    localName: '3. lesh guri.png',
    targetName: 'france-comble_3._lesh_guri.png',
    dbColumn: 'layers_iso_inter_roche_id',
    alt: 'France Comble - Isolation intermédiaire laine de roche',
    mime: 'image/png'
  },
  {
    localName: '4. lesh druri.png',
    targetName: 'france-comble_4._lesh_druri.png',
    dbColumn: 'layers_iso_inter_bois_id',
    alt: 'France Comble - Isolation intermédiaire laine de bois',
    mime: 'image/png'
  },
  {
    localName: '5. lesh xhami.png',
    targetName: 'france-comble_5._lesh_xhami.png',
    dbColumn: 'layers_iso_inter_verre_id',
    alt: 'France Comble - Isolation intermédiaire laine de verre',
    mime: 'image/png'
  },
  {
    localName: '6. lesh guri ne kulm.png',
    targetName: 'france-comble_6._lesh_guri_ne_kulm.png',
    dbColumn: 'layers_roof_roche_id',
    alt: 'France Comble - Isolation toiture laine de roche',
    mime: 'image/png'
  },
  {
    localName: '7. lesh druri ne kulm.png',
    targetName: 'france-comble_7._lesh_druri_ne_kulm.png',
    dbColumn: 'layers_roof_bois_id',
    alt: 'France Comble - Isolation toiture laine de bois',
    mime: 'image/png'
  },
  {
    localName: '8. lesh xhami.png',
    targetName: 'france-comble_8._lesh_xhami_ne_kulm.png',
    dbColumn: 'layers_roof_verre_id',
    alt: 'France Comble - Isolation toiture laine de verre',
    mime: 'image/png'
  },
  {
    localName: '9. stiropori.png',
    targetName: 'france-comble_9._stiropori.png',
    dbColumn: 'layers_iso_ext_polystyrene_id',
    alt: 'France Comble - Isolation extérieure polystyrène',
    mime: 'image/png'
  },
  {
    localName: '10. lesh guri jashte.png',
    targetName: 'france-comble_10._lesh_guri_jashte.png',
    dbColumn: 'layers_iso_ext_roche_comprimee_id',
    alt: 'France Comble - Isolation extérieure laine de roche',
    mime: 'image/png'
  },
  {
    localName: '11. fibra.png',
    targetName: 'france-comble_11._fibra.png',
    dbColumn: 'layers_iso_ext_fibre_id',
    alt: 'France Comble - Isolation extérieure fibre de bois',
    mime: 'image/png'
  },
  {
    localName: '12. folia dhe listelat.png',
    targetName: 'france-comble_12._folia_dhe_listelat.png',
    dbColumn: 'layers_couverture_pare_pluie_lattage_id',
    alt: 'France Comble - Pare-pluie et lattage',
    mime: 'image/png'
  },
  {
    localName: '13. fasada e bardhe.png',
    targetName: 'france-comble_13._fasada_e_bardhe.png',
    dbColumn: 'layers_facade_blanche_id',
    alt: 'France Comble - Façade enduit blanc',
    mime: 'image/png'
  },
  {
    localName: '14. fasada arish.png',
    targetName: 'france-comble_14._fasada_arish.png',
    dbColumn: 'layers_facade_bardage_id',
    alt: 'France Comble - Façade bardage mélèze',
    mime: 'image/png'
  },
  {
    localName: '15. dritaret alumin.png',
    targetName: 'france-comble_15._dritaret_alumin.png',
    dbColumn: 'layers_windows_aluminium_id',
    alt: 'France Comble - Menuiseries aluminium',
    mime: 'image/png'
  },
  {
    localName: '16. dritaret pvc.png',
    targetName: 'france-comble_16._dritaret_pvc.png',
    dbColumn: 'layers_windows_pvc_id',
    alt: 'France Comble - Menuiseries PVC',
    mime: 'image/png'
  },
  {
    localName: '17. qeremidet.png',
    targetName: 'france-comble_17._qeremidet.png',
    dbColumn: 'layers_couverture_tuiles_gouttieres_id',
    alt: 'France Comble - Couverture tuiles et gouttières',
    mime: 'image/png'
  },
  {
    localName: '18. llamarina.png',
    targetName: 'france-comble_18._llamarina.png',
    dbColumn: 'layers_couverture_bac_acier_gouttieres_id',
    alt: 'France Comble - Couverture bac acier et gouttières',
    mime: 'image/png'
  },
  {
    localName: '19. lesh guri ne pllake.png',
    targetName: 'france-comble_19._lesh_guri_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_roche_id',
    alt: 'France Comble - Isolation faux plafond laine de roche',
    mime: 'image/png'
  },
  {
    localName: '20. lesh druri ne pllake.png',
    targetName: 'france-comble_20._lesh_druri_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_bois_id',
    alt: 'France Comble - Isolation faux plafond laine de bois',
    mime: 'image/png'
  },
  {
    localName: '21. lesh xhami ne pllake.png',
    targetName: 'france-comble_21._lesh_xhami_ne_pllake.png',
    dbColumn: 'layers_faux_plafond_verre_id',
    alt: 'France Comble - Isolation faux plafond laine de verre',
    mime: 'image/png'
  },
  {
    localName: 'france comble 5.jpg',
    targetName: 'france-comble_default.jpg',
    dbColumn: 'default_image_id',
    alt: 'France Comble',
    mime: 'image/jpeg'
  },
  {
    localName: 'france comble 7.jpg',
    targetName: 'france-comble_final.jpg',
    dbColumn: 'final_image_id',
    alt: 'France Comble - Rendu Final',
    mime: 'image/jpeg'
  }
];
...
async function main() {
  ...
  try {
    ...
    // Clean up existing house row with slug 'france-comble' if exists to prevent duplicates
    console.log(' - Cleaning up old france-comble references if any...');
    
    const findHouseRes = await pgClient.query("SELECT id FROM houses WHERE slug = 'france-comble'");
    ...
    console.log(' - Cleaning up old france-comble media from DB...');
    await pgClient.query(`
      DELETE FROM media_locales 
      WHERE _parent_id IN (
        SELECT id FROM media WHERE filename LIKE 'france-comble\\_%' ESCAPE '\\'
      )
    `);
    const cleanupRes = await pgClient.query(`
      DELETE FROM media WHERE filename LIKE 'france-comble\\_%' ESCAPE '\\' RETURNING id
    `);
    ...
    console.log(' - Inserting house france-comble in houses table...');
    ...
    console.log(`Successfully inserted house france-comble with ID: ${newHouseId}`);
