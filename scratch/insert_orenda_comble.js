...
const IMAGES_DIR = '/Users/blendsylqevci/Desktop/Projects/ossaboisfrance/public/images/houses/orenda comble';

const fileMappings = [
  {
    localName: '1. prapavija.png',
    targetName: 'orenda-comble_1._prapavija.png',
    dbColumn: 'layers_background_layer_id',
    alt: 'Orenda Comble - Arrière-plan',
    mime: 'image/png'
  },
  {
    localName: '2. kons.png',
    targetName: 'orenda-comble_2._kons.png',
    dbColumn: 'layers_construction_layer_id',
    alt: 'Orenda Comble - Structure de construction',
    mime: 'image/png'
  },
  {
    localName: '3. lesh guri.png',
    targetName: 'orenda-comble_3._lesh_guri.png',
    dbColumn: 'layers_iso_inter_roche_id',
    alt: 'Orenda Comble - Isolation intermédiaire laine de roche',
    mime: 'image/png'
  },
  {
    localName: '4. lesh druri.png',
    targetName: 'orenda-comble_4._lesh_druri.png',
    dbColumn: 'layers_iso_inter_bois_id',
    alt: 'Orenda Comble - Isolation intermédiaire laine de bois',
    mime: 'image/png'
  },
  {
    localName: '5. lesh xhami.png',
    targetName: 'orenda-comble_5._lesh_xhami.png',
    dbColumn: 'layers_iso_inter_verre_id',
    alt: 'Orenda Comble - Isolation intermédiaire laine de verre',
    mime: 'image/png'
  },
  {
    localName: '6. lesh guri ne kulm.png',
    targetName: 'orenda-comble_6._lesh_guri_ne_kulm.png',
    dbColumn: 'layers_roof_roche_id',
    alt: 'Orenda Comble - Isolation toiture laine de roche',
    mime: 'image/png'
  },
  {
    localName: '7.  lesh druri.png',
    targetName: 'orenda-comble_7._lesh_druri_ne_kulm.png',
    dbColumn: 'layers_roof_bois_id',
    alt: 'Orenda Comble - Isolation toiture laine de bois',
    mime: 'image/png'
  },
  {
    localName: '8. lesh xhami ne kulm.png',
    targetName: 'orenda-comble_8._lesh_xhami_ne_kulm.png',
    dbColumn: 'layers_roof_verre_id',
    alt: 'Orenda Comble - Isolation toiture laine de verre',
    mime: 'image/png'
  },
  {
    localName: '9. stiropori.png',
    targetName: 'orenda-comble_9._stiropori.png',
    dbColumn: 'layers_iso_ext_polystyrene_id',
    alt: 'Orenda Comble - Isolation extérieure polystyrène',
    mime: 'image/png'
  },
  {
    localName: '10. lesh guri jashte.png',
    targetName: 'orenda-comble_10._lesh_guri_jashte.png',
    dbColumn: 'layers_iso_ext_roche_comprimee_id',
    alt: 'Orenda Comble - Isolation extérieure laine de roche',
    mime: 'image/png'
  },
  {
    localName: '11. fibra.png',
    targetName: 'orenda-comble_11._fibra.png',
    dbColumn: 'layers_iso_ext_fibre_id',
    alt: 'Orenda Comble - Isolation extérieure fibre de bois',
    mime: 'image/png'
  },
  {
    localName: '12. folia dhe listelat.png',
    targetName: 'orenda-comble_12._folia_dhe_listelat.png',
    dbColumn: 'layers_couverture_pare_pluie_lattage_id',
    alt: 'Orenda Comble - Pare-pluie et lattage',
    mime: 'image/png'
  },
  {
    localName: '13. fasada e bardhe.png',
    targetName: 'orenda-comble_13._fasada_e_bardhe.png',
    dbColumn: 'layers_facade_blanche_id',
    alt: 'Orenda Comble - Façade enduit blanc',
    mime: 'image/png'
  },
  {
    localName: '14. fasada arish.png',
    targetName: 'orenda-comble_14._fasada_arish.png',
    dbColumn: 'layers_facade_bardage_id',
    alt: 'Orenda Comble - Façade bardage mélèze',
    mime: 'image/png'
  },
  {
    localName: '15. dritaret alumin.png',
    targetName: 'orenda-comble_15._dritaret_alumin.png',
    dbColumn: 'layers_windows_aluminium_id',
    alt: 'Orenda Comble - Menuiseries aluminium',
    mime: 'image/png'
  },
  {
    localName: '16. dritaret pvc.png',
    targetName: 'orenda-comble_16._dritaret_pvc.png',
    dbColumn: 'layers_windows_pvc_id',
    alt: 'Orenda Comble - Menuiseries PVC',
    mime: 'image/png'
  },
  {
    localName: '17. llamarina.png',
    targetName: 'orenda-comble_17._llamarina.png',
    dbColumn: 'layers_couverture_bac_acier_gouttieres_id',
    alt: 'Orenda Comble - Couverture bac acier et gouttières',
    mime: 'image/png'
  },
  {
    localName: 'orenda 7.jpg',
    targetName: 'orenda-comble_default.jpg',
    dbColumn: 'default_image_id',
    alt: 'Orenda Comble',
    mime: 'image/jpeg'
  },
  {
    localName: 'orenda 10.jpg',
    targetName: 'orenda-comble_final.jpg',
    dbColumn: 'final_image_id',
    alt: 'Orenda Comble - Rendu Final',
    mime: 'image/jpeg'
  }
];
...
async function main() {
  ...
  try {
    ...
    console.log(' - Cleaning up old orenda-comble media from DB...');
    await pgClient.query(`
      DELETE FROM media_locales 
      WHERE _parent_id IN (
        SELECT id FROM media WHERE filename LIKE 'orenda-comble\\_%' ESCAPE '\\'
      )
    `);
    const cleanupRes = await pgClient.query(`
      DELETE FROM media WHERE filename LIKE 'orenda-comble\\_%' ESCAPE '\\' RETURNING id
    `);
    ...
    // Check if house orenda exists
    const findHouseRes = await pgClient.query("SELECT id FROM houses WHERE slug = 'orenda'");
    let houseId;

    if (findHouseRes.rowCount > 0) {
      houseId = findHouseRes.rows[0].id;
      console.log(`Found existing house orenda with ID: ${houseId}. Updating it...`);
      ...
      await pgClient.query(updateHouseQuery, [
        ...
        false, // enable_flags_enable_faux_plafond_option (no faux plafond layers)
        ...
        null, // layers_couverture_tuiles_gouttieres_id (no tiles)
      ...
      console.log('House orenda not found. Creating a new record...');
