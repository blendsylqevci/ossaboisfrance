...
<div class="checkout-page">
    ...
    <div class="checkout-container">
        ...
        <div class="checkout-content">
                                ...
                                <div class="transportation-content">
                                    <div class="transportation-info">
                                        <span class="transportation-name">Transport standard</span>
                                          <span class="transportation-description">Livraison à votre adresse sous 15 à 20 jours</span>
                                    </div>
                                    <span class="transportation-price" id="transportation-price">€3,000.00</span>
                                </div>
                            </label>
                        </div>
        </div>
            ...
            <div class="order-summary-card">
                ...
                <div class="order-summary-footer">
                    ...
                    <p class="terms-text">En passant votre commande, vous acceptez nos Conditions générales</p>
                </div>
            </div>
        </div>
        ...
        <h3>Merci pour votre commande&nbsp;!</h3>
         <p>Nous avons bien reçu votre demande et nous vous contacterons sous peu.</p>
        </div>
    </div>
</div>
...
let basePrice = Number(data.totalPrice) || 0;
                ...
                if (houseImage && houseImage.startsWith('http')) {
                    console.log('[Checkout] ✓ Valid image URL found:', houseImage);
                } else {
                    console.warn('[Checkout] ⚠ Image URL may be invalid:', houseImage);
                }
