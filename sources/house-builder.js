...
\
    if (selectedLabels.isolation) \{\
      breakdownItems.push(\{\
        label: 'Isolation interm\'e9diaire \'97 ' + selectedLabels.isolation,\
...
\
    if (selectedLabels.outerIsolation) \{\
      breakdownItems.push(\{\
        label: 'Isolation ext\'e9rieure \'97 ' + selectedLabels.outerIsolation,\
...
\
    if (selectedLabels.facade) \{\
      breakdownItems.push(\{\
        label: 'Rev\'eatement ext\'e9rieur \'97 ' + selectedLabels.facade,\
        value: costFacade\
      \});\
    \}\
\
    if (selectedLabels.etancheite) \{\
      breakdownItems.push(\{\
        label: '\'c9tanch\'e9it\'e9 / Pare-pluie \'97 ' + selectedLabels.etancheite,\
...
\
    if (selectedLabels.roof) \{\
      breakdownItems.push(\{\
        label: 'Isolation de la toiture par l\'92ext\'e9rieur \'97 ' + selectedLabels.roof,\
        value: costRoof\
      \});\
    \}\
\
    if (selectedLabels.toiture) \{\
      breakdownItems.push(\{\
        label: 'Couverture \'97 ' + selectedLabels.toiture,\
        value: costToiture\
      \});\
    \}\
\
    if (selectedLabels.terrasse) \{\
      breakdownItems.push(\{\
        label: '\'c9tanch\'e9it\'e9 toiture terrasse avec couvertine \'97 ' + selectedLabels.terrasse,\
...
\
    if (selectedLabels.fauxPlafond) \{\
      breakdownItems.push(\{\
        label: 'Faux plafond \'97 ' + selectedLabels.fauxPlafond,\
...
\
    if (selectedLabels.dritaret) \{\
      breakdownItems.push(\{\
        label: 'Menuiseries ext\'e9rieures \'97 ' + selectedLabels.dritaret,\
        value: costDritaret\
      \});\
    \}\
\
...
\
    items.forEach(function(item) \{\
      const breakdownHtml =\
        ...
        '<span class="breakdown-value">\'80 ' + formatPrice(item.value) + '</span>' +\
        '</div>';\
\
...
\
    if (facadeName.indexOf('enduit') !== -1 || facadeName.indexOf('crepis') !== -1 || facadeName.indexOf('cr\'e9pis') !== -1) return 'enduit';\
